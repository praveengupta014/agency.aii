...
backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
    ...
    <div className={`text-gray-700 dark:text-white sm:text-sm ${!sidebaropen ? 'max-sm:w-60 max-sm:pl-10' : 'max-sm:w-0 overflow-hidden'}
    ...
    max-sm:text-white max-sm:pt-20 flex sm:items-center gap-5 transition-all`}>
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
          ...
          text-white px-6 py-2 rounded-full cursor-pointer hover:scale-103 transition-all'>
                Connect <img src={assets.arrow_icon} width={14} alt=''></img>
         </a>
    </div>
