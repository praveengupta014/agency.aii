  ...
  return (
    <div id='Hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        className='inline-flex items-center gap-2 border border-gray-300 p-1.5
            ...
            <p className='text-xs-medium-font'> Trusted by 10k+ people </p>
        </motion.div>
        ...
        className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into <br /> interactive digital experiences.</motion.p>
        <motion.div 
