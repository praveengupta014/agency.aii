...
const ContactUs = () => {
    ...
    formData.append("access_key", "de1e09bd-0262-4062-85dc-2c554db79c2a");
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12
             1g:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
...
I
          ...
          onSubmit={onsubmit}className= 'grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2x1 w-full'>

            <div>
                <p className='mb-2 text-sm font-medium'>your Name</p>
                <div className='flex pl-3 rounded-1g border border-gray-300  dark: border-gray-600'>
            ...
            <div className='sm:col-span-2'>
                <p className='mb-2 text-sm font-medium'>Message</p>
                 <textarea name="message" rows={8} placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-1g border border-gray-300
